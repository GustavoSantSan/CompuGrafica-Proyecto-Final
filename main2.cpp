...
camTopDown.isTopDown = true;
  ...
  Pokemon2Texture.LoadTextureA();
	...
	Dragon_M = Model();
	Dragon_M.LoadModel("Models/dragon sin base.obj");
	Dragon_Ala_Der_M = Model();
	Dragon_Ala_Der_M.LoadModel("Models/ala-derecha.obj");
	Dragon_Ala_Izq_M = Model();
	Dragon_Ala_Izq_M.LoadModel("Models/ala-izquierda.obj");
  Dragonite_M = Model();
  Dragonite_M.LoadModel("Models/Dragonite.obj");

  Dragonite_Ala_Der_M = Model();
  Dragonite_Ala_Izq_M = Model();
  Dragonite_Ala_Izq_M.LoadModel("Models/DragoniteAlaIzq.obj");
  Dragonite_Ala_Der_M.LoadModel("Models/DragoniteAlaDer.obj");
